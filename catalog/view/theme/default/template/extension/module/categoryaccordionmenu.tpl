		...
		<ul class="<?php if(isset($fm_custom_class_parent)) echo $fm_custom_class_parent; ?>">
			<?php foreach ($categories as $category) { ?>
				<?php if ($category['category_id'] == $category_id) { ?>
						<li class="selected"><a href="<?php echo $category['href']; ?>"><?php if($fm_main_icon_display) echo "<i class='fa ". $fm_main_icon ." '></i>"; ?> <?php echo $category['name']; ?></a>
							<?php if ($category['children']) { ?>
								<ul class="<?php if(isset($fm_custom_class_child)) echo $fm_custom_class_child; ?>">
									<?php foreach ($category['children'] as $child) { ?>
										<?php if ($child['category_id'] == $child_id) { ?>
											<li class="selected" class="1stlevel"><a href="<?php echo $child['href']; ?>"><?php if($fm_child_icon_display) echo "<i class='fa ". $fm_child_icon ." '></i>"; ?> <?php echo $child['name']; ?></a>
												<?php if ($child['children_2']) { ?>
													<ul class="<?php if(isset($fm_custom_class_child)) echo $fm_custom_class_child; ?>">
														<?php foreach ($child['children_2'] as $child_2) { ?>
															<?php if ($child_2['category_id'] == $child_2_id) { ?>
																<li class="selected" class="2ndlevel"><a href="<?php echo $child_2['href']; ?>"><?php if($fm_child_icon_display) echo "<i class='fa ". $fm_child_icon ." '></i>"; ?> <?php echo $child_2['name']; ?></a>
																	<?php if($child_2['children_3']) { ?>
																	<ul class="<?php if(isset($fm_custom_class_child)) echo $fm_custom_class_child; ?>">
																		<?php foreach ($child_2['children_3'] as $child_3) { ?>
																			<?php if ($child_3['category_id'] == $child_3_id) { ?>
																				<li class="selected" class="3rdlevel"><a href="<?php echo $child_3['href']; ?>"><?php if($fm_child_icon_display) echo "<i class='fa ". $fm_child_icon ." '></i>"; ?> <?php echo $child_3['name']; ?></a>
																					<?php if($child_3['children_4']) { ?>
																						<ul class="<?php if(isset($fm_custom_class_child)) echo $fm_custom_class_child; ?>">
																							<?php foreach ($child_3['children_4'] as $child_4) { ?>
																								<?php if ($child_4['category_id'] == $child_4_id) { ?>
																									<li class="selected" class="4thlevel"><a href="<?php echo $child_4['href']; ?>"><?php if($fm_child_icon_display) echo "<i class='fa ". $fm_child_icon ." '></i>"; ?> <?php echo $child_4['name']; ?></a>
																										<?php if($child_4['children_5']) { ?>
																											<ul class="<?php if(isset($fm_custom_class_child)) echo $fm_custom_class_child; ?>">
																												<?php foreach ($child_4['children_5'] as $child_5) { ?>
																													<?php if ($child_5['category_id'] == $child_5_id) { ?>
																														<li class="selected" class="5thlevel"><a href="<?php echo $child_5['href']; ?>"><?php if($fm_child_icon_display) echo "<i class='fa ". $fm_child_icon ." '></i>"; ?> <?php echo $child_5['name']; ?></a></li>
																													<?php } else { ?>
																														<li class="5thlevel"><a href="<?php echo $child_5['href']; ?>"><?php if($fm_child_icon_display) echo "<i class='fa ". $fm_child_icon ." '></i>"; ?> <?php echo $child_5['name']; ?></a></li>
																													<?php } ?>
																												<?php } ?>
																											</ul>
																										<?php }  ?>
																								...
																								<?php } else { ?>
																									<li class="4thlevel"><a href="<?php echo $child_4['href']; ?>"><?php if($fm_child_icon_display) echo "<i class='fa ". $fm_child_icon ." '></i>"; ?> <?php echo $child_4['name']; ?></a>
																										<?php if($child_4['children_5']) { ?>
																											<ul class="<?php if(isset($fm_custom_class_child)) echo $fm_custom_class_child; ?>">
																												<?php foreach ($child_4['children_5'] as $child_5) { ?>
																													<?php if ($child_5['category_id'] == $child_5_id) { ?>
																			...
																			<?php } else { ?>
																				<li class="3rdlevel"><a href="<?php echo $child_3['href']; ?>"><?php if($fm_child_icon_display) echo "<i class='fa ". $fm_child_icon ." '></i>"; ?> <?php echo $child_3['name']; ?></a>
																					<?php if($child_3['children_4']) { ?>
																						<ul class="<?php if(isset($fm_custom_class_child)) echo $fm_custom_class_child; ?>">
																							<?php foreach ($child_3['children_4'] as $child_4) { ?>
																								<li class="4thlevel"><a href="<?php echo $child_4['href']; ?>"><?php if($fm_child_icon_display) echo "<i class='fa ". $fm_child_icon ." '></i>"; ?> <?php echo $child_4['name']; ?></a>
															...
															<?php } else { ?>
																<li class="2ndlevel"><a href="<?php echo $child_2['href']; ?>"><?php if($fm_child_icon_display) echo "<i class='fa ". $fm_child_icon ." '></i>"; ?> <?php echo $child_2['name']; ?></a>
																	<?php if($child_2['children_3']) { ?>
																		<ul class="<?php if(isset($fm_custom_class_child)) echo $fm_custom_class_child; ?>">
																			<?php foreach ($child_2['children_3'] as $child_3) { ?>
																				<li class="3rdlevel"><a href="<?php echo $child_3['href']; ?>"><?php if($fm_child_icon_display) echo "<i class='fa ". $fm_child_icon ." '></i>"; ?> <?php echo $child_3['name']; ?></a>
										...
										<?php } else { ?>
											<li class="1stlevel"><a href="<?php echo $child['href']; ?>"><?php if($fm_child_icon_display) echo "<i class='fa ". $fm_child_icon ." '></i>"; ?> <?php echo $child['name']; ?></a>
												<?php if ($child['children_2']) { ?>
													<ul class="<?php if(isset($fm_custom_class_child)) echo $fm_custom_class_child; ?>">
														<?php foreach ($child['children_2'] as $child_2) { ?>
															<li class="2ndlevel"><a href="<?php echo $child_2['href']; ?>"><?php if($fm_child_icon_display) echo "<i class='fa ". $fm_child_icon ." '></i>"; ?> <?php echo $child_2['name']; ?></a>
					...
					<?php } else { ?>
						<li><a href="<?php echo $category['href']; ?>"><?php if($fm_main_icon_display) echo "<i class='fa ". $fm_main_icon ." '></i>"; ?> <?php echo $category['name']; ?></a>
							<?php if ($category['children']) { ?>
								<ul class="<?php if(isset($fm_custom_class_child)) echo $fm_custom_class_child; ?>">
									<?php foreach ($category['children'] as $child) { ?>
										<li class="1stlevel"><a href="<?php echo $child['href']; ?>"><?php if($fm_child_icon_display) echo "<i class='fa ". $fm_child_icon ." '></i>"; ?> <?php echo $child['name']; ?></a>
